...
[reference : Spring data JPA docs](https://docs.spring.io/spring-data/jpa/docs/current/reference/html/#repositories.query-methods.query-property-expressions) 

 so use **camel case** to declare column name , which is convention ways of JAVA(Strongly recommended), or use __ instead.
...
public interface BookRepo extends JpaRepository<Book,Long> {
    List<Book> getByAuthor_name;
}
```
if run Test, would failed as below
